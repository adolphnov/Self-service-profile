          ...
          if (media_source.Id == media_source_id) {
            ...
            switch(type)
            {
                ...
                case "iina_play":
                    ...
                    $util.done({body: "IINA play", headers: {Location:iina_url_scheme}, status: "HTTP/1.1 302 Found"})
                    break;
                case "movist_pro_play":
                    ...
                    $util.done({body: "Movist Pro play", headers: {Location:movist_pro_scheme}, status: "HTTP/1.1 302 Found"})
                    break;
                default:
